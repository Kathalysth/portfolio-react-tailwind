        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-24">
          ...
          <div className="text-center">
            <h1
              data-aos="fade-up"
              data-aos-once="true"
              className=" text-3xl font-bold tracking-snug z-[2] text-gray-900 dark:text-gray-200 md:text-6xl"
            >
              Transforming Ideas into Accessible and Performant Web{" "}
              <div className="bg-teal-600 rounded-xl inline-block pb-1 px-1 text-white z-[1]">
                apps
              </div>
              .
            </h1>
